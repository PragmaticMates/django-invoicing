...
@task
def mail_exported_invoices_mrp_v1(export_id, exporter_subclass_paths=None, filename=None, language=settings.LANGUAGE_CODE):
    ...
    with transaction.atomic():
        ...
        if exporter_subclass_paths:
            ...
            exporters = [
                InvoiceFakvyXmlMrpExporter(user=export.creator, recipients=export.recipients, params={}),
                InvoiceFakvypolXmlMrpExporter(user=export.creator, recipients=export.recipients, params={}),
                InvoiceFvAdresXmlMrpExporter(user=export.creator, recipients=export.recipients, params={}),
            ]
