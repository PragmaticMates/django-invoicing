...
ACCOUNTING_SOFTWARE_MRP_API_URL = getattr(settings, 'INVOICING_ACCOUNTING_SOFTWARE_MRP_API_URL', None)
ACCOUNTING_SOFTWARE_MANAGER = getattr(settings, 'INVOICING_ACCOUNTING_SOFTWARE_MANAGER', None)

INVOICE_DETAILS_MANAGER = getattr(settings, 'INVOICING_INVOICE_DETAILS_MANAGER')
